...
class SpecialDividend(Base):
    ...
    corporate_action = relationship("CorporateAction", backref="special_dividend")
    ...
    def __repr__(self):
        return f"<SpecialDividend(dividend_amount={self.dividend_amount}, " \
